...
class ImageNetLTDataLoader_base(DataLoader):
    """
...
class ImageNetLTDataLoader(DataLoader):
    ...
    def __init__(self, data_dir, batch_size, shuffle=True, num_workers=1, training=True, balanced=False, retain_epoch_size=True, 
                 train_txt="./data_txt/ImageNet_LT/ImageNet_LT_train.txt", 
                #  train_txt="./data_txt/ImageNet_LT/ImageNet_LT_normal_0.5.txt", 
                 val_txt="./data_txt/ImageNet_LT/ImageNet_LT_val.txt", 
                 test_txt="./data_txt/ImageNet_LT/ImageNet_LT_test.txt",
                 drop_last=False, **kwargs
                 ):

        base_train_trsfm = transforms.Compose([
            transforms.RandomResizedCrop(224),
            transforms.RandomHorizontalFlip(),
            transforms.ColorJitter(brightness=0.4, contrast=0.4, saturation=0.4, hue=0),
            transforms.ToTensor(),
        ...
        train_trsfm = TwoCropTransform(base_train_trsfm)
        ...
        super().__init__(dataset=self.dataset, drop_last=drop_last, **self.init_kwargs, sampler=sampler, **kwargs) # Note that sampler does not apply to validation set
